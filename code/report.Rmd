...
# Price Money
`r playerName`'s total price money is `r priceMoneyUSDollarTotal`. The following figure shows how it developed over time.
...
```{r, echo = FALSE, results = 'asis'}
if(numberOfMatches > 100 & !is.nan(rSquared)) {
