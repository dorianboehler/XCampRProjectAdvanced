...
\centerline{\LARGE University of St. Gallen}
\vspace{0.5cm}
\centerline{\Large School of Management, Economics, Law,}
\centerline{\Large Social Sciences, International Affairs, and Computer Science}



\vspace{3cm}

\centerline{\LARGE A Detailed Analysis of `r playerName`’s Results}

\vspace{3cm}

\centerline{\Large Noah Baiguini, Dorian Böhler}
\vspace{0.5cm}
\centerline{\large   (21-619-507), (15-613-433)}

\vspace{3cm}

\centerline{\LARGE \today}
\vspace{0.5cm}
\centerline{\Large Skills: Programming}
\vspace{0.5cm}
\centerline{\Large Mr. Mario Silic}
\newpage
...
&nbsp;
\newpage
In the following figure, you can see the accumulation of tournament won,but also the finals `r playerName` lost, the crosses:
...
# Price Money
`r playerName`'s total price money is `r priceMoneyUSDollarTotal`.You can see how it developed over time.
